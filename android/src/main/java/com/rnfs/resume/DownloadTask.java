...
public class DownloadTask {
    ...
    public DownloadTask(Context mContext, FileInfo mFileInfo, DownloadService service) {
    ...
    public void download() {
        ...
        new DownloadThread(threadInfo,this.service).start();
    ...
    class DownloadThread extends Thread {
        ...
        public DownloadThread(DownloadThreadInfo threadInfo,DownloadService service) {
            ...
            try {
                ...
                if (HttpURLConnection.HTTP_PARTIAL == connection.getResponseCode()) {
                    ...
                    while ((len = input.read(buffer)) != -1) {
                        ...
                        this.service.onPregress(mProgress);
                        //暂停状态，保存下载信息到数据库
                        if (isPause) {
